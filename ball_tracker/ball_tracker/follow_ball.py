...
class FollowBall(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("rcv_timeout_secs", 0.1)
        ...
        self.declare_parameter("max_size_thresh", 0.5)
        self.declare_parameter("filter_value", 0.95)
    ...
    def timer_callback(self):
        ...
        if (time.time() - self.lastrcvtime < self.rcv_timeout_secs):
            ...
            # Do not rotate or move when target is lost
            self.target_val = 0.0
            self.target_dist = 0.0
            pass
